		...
		global $posterity_a13; ?>
			<div class="foot-items">
				<div class="foot-content clearfix">
					...
					?>
					<div class="credtext">
                    	<?php esc_html_e('By ','skt-green');?>
                        <?php if( is_home() && is_front_page()) {?>
                        <a class="credlink" href="<?php echo esc_url('https://www.sktthemes.org/');?>" target="_blank"><?php esc_html_e('SKT Themes','skt-green'); ?></a>
                        <?php } else {?>
                          <?php esc_html_e('SKT Themes','skt-green'); ?>
                        <?php } ?>
                    </div>
					<?php
